...
if (empty($profile_picture)) {
    $profile_picture = 'uploads/default-profile.png';  // الصورة الافتراضية
}
...
.dropdown-menu .dropdown-icon {
    ...
    height: 25px;
    margin-left: 10.5px;
    filter: brightness(0) saturate(100%) invert(32%) sepia(14%) saturate(1500%) hue-rotate(2deg) brightness(90%) contrast(90%);
}
...
<header class="header">
    <div class="icons">
        ...
        <div class="dropdown">
            ...
            <img src="<?php echo $profile_picture; ?>" alt="الحساب" style="border-radius: 50%; width: 3rem; height: 3rem; object-fit: cover;">
